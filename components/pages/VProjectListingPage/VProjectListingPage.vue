...
<template>
  <VDefaultHeader :title="pageData.title" :anchor-id="anchor.LISTING_PAGE_PROJECTS_CONTAINER" />
  <ul :id="anchor.LISTING_PAGE_PROJECTS_CONTAINER" :class="$style.list">
    <li v-for="projectDocument in listingResponse" :key="projectDocument.id" :class="$style.item">
      <a href="">
